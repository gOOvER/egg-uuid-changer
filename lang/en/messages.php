...
return [
    ...
    'import_prompt_label' => 'Change Imported UUID?',
    ...
    'notifications' => [
        ...
        'import_detected_title' => 'Egg successfully imported',
        'import_detected_body' => 'Would you like to change the UUID of the imported egg?',
        'change_uuid_action' => 'Change UUID',
        'keep_uuid_action' => 'Keep UUID',
