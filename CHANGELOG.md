...
- Optional auto-prompt on import feature
...
- Import action button to change UUID during egg import (when enabled)
- Event listener for automatic UUID changes after import
